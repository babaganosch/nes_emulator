...
constexpr uint8_t reverse_byte_lookup_table[] = {
...
bool ppu_t::check_vblank()
{
    return render_state == ppu_t::render_states::vertical_blanking_line;
}
