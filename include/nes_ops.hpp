...
OP_FUNCTION(SRE); // LSE
OP_FUNCTION(RRA); //
OP_FUNCTION(ANC); // ANC2
OP_FUNCTION(JAM); // KIL, HLT
OP_FUNCTION(ARR); //
OP_FUNCTION(ANE); // XAA
OP_FUNCTION(SHA); // AHX, AXA
OP_FUNCTION(TAS); // XAS, SHS
OP_FUNCTION(SHY); // A11, SYA, SAY
OP_FUNCTION(SHX); // A11, SXA, XAS
OP_FUNCTION(LXA); // LAX immediate
OP_FUNCTION(LAS); // LAR
OP_FUNCTION(SBX); // AXS, SAX
